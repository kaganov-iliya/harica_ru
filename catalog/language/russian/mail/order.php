...
$_['text_new_greeting']         = 'Благодарим вас за интерес к товарам %s. Ваш заказ будет обработан в ближайшее время, с вами свяжется оператор и согласует с вам детали оплаты и доставки.';
