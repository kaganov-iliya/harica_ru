...
$_['error_telephone']          = 'Поле не является допустимым форматом телефонного номера. Необходимый формат: +7(000)12-34-567';
$_['text_success_order']       = 'Заказ #%s успешно оформлен!';