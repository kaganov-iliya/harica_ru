(function($) {
    ...
    SimplecheckoutBlock.prototype.restoreFocus = function() {
        ...
        if (focusedField.length && focusedField.is(":visible") && ((focusedField.attr("type") && focusedField.attr("type") == "text" && !focusedField.attr("data-type")) || focusedField.is("textarea"))) {
