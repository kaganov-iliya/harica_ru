  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php } ?>
          ...
          <div id="product">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>" class="row">
                <?php foreach ($option['product_option_value'] as $option_value) { ?>
                <div class="radio-list col-xs-6 col-sm-4 col-md-6 col-lg-4">
                  <label>
                    <input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" onchange="thumb('<?php echo $option_value['thumb']; ?>');" />
            ...
            <div class="form-group cart">
              ...
              <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button><span>&nbsp;&nbsp;- <?php echo $text_or ?> -&nbsp;&nbsp;</span>
			   <div class="btn-group">
            ...
            <p>
            	<input type="text" name="telephone" placeholder="Номер телефона" autocomplete="off" class="form-control" />
             	<button type="button" id="button-checkout" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default">Купить</button>
            </p>
			<p>Если есть вопросы по этому товару, звоните нам 8 (495) 111-11-11</p> 
            </div>
            
             <?php if ($downloads) { ?>
            <div class="form-group">
                <?php foreach ($downloads as $download) { ?>
					<p><a class="download-file" href="<?php echo $download['href']; ?>"><?php echo $download['name']; ?></a> <?php echo $download['size']; ?></p>
                <?php } ?>                 
            </div>
             <?php } ?>
        ...
        <ul class="nav nav-tabs">
            ...
            <?php if ($features) { ?>
                <li><a href="#tab-features" data-toggle="tab"><?php echo $entry_features; ?></a></li>
            <?php } ?>

            <?php if ($yt_video) { ?>
                <li><a href="#tab-yt_video" data-toggle="tab"><?php echo $entry_yt_video; ?></a></li>
            <?php } ?>
          ...
          <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-yt_video"><?php echo $yt_video; ?></div>
	  ...
	  <div class="box related">
	   ...
	   <div class="box-content">
			...
			?>
				...
				{ 
					$maxLength = 25 ; echo utf8_substr($product['name'],0,$maxLength).".."; 
				}
				else{
					echo ($product['name']);
				}
