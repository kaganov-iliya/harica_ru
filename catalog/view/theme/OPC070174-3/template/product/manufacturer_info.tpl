  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<div class="btn-list-grid">
             ...
             <div class="list-right">
					...
					<div class="list-buttoncart">  
							 <div class="button-group">
							 	   <button type="button" class="addtocart"  title="<?php echo $button_cart; ?>"  onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><?php echo $button_cart; ?></button>
							 </div>
      ...
      <div class="pagination-wrapper">
	   ...
	   <?php if ($description) { ?>
<span style="margin-top: 50px; display: block;"><?php echo $description; ?></span>
<?php } ?>
      <?php } else { ?>
