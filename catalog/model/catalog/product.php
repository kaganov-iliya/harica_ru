...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'stock_status_id'  => $query->row['stock_status_id'], # ilsur 03.04.17
	...
	public function getDownload($download_id) {
		$query = $this->db->query("SELECT d.filename, d.mask, dd.name FROM `" . DB_PREFIX . "download` d LEFT JOIN `" . DB_PREFIX . "download_description` dd ON (d.download_id = dd.download_id) WHERE d.download_id = '" . (int)$download_id . "'");
		return $query->row;
	}
}
