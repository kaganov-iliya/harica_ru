...
<div id="content">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-main-seo-text"><?php echo $entry_seo_text; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_main_seo_text" rows="5" placeholder="<?php echo $entry_seo_text; ?>" id="input-main-seo-text" class="form-control"><?php echo $config_main_seo_text; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-second-logo"><?php echo $entry_second_logo; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-second-logo" data-toggle="second-image" class="img-thumbnail"><img src="<?php echo $second_logo; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_second_logo" value="<?php echo $config_second_logo; ?>" id="input-second-logo" />
                </div>
              </div>
              <div class="form-group">
  ...
  <script type="text/javascript"><!--
    ...
    ckeditorInit('input-main-seo-text', '<?php echo $token; ?>');
