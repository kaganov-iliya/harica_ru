        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-features<?php echo $language['language_id']; ?>"><?php echo $entry_features; ?></label>
                <div class="col-sm-10">
                  <textarea name="product_description[<?php echo $language['language_id']; ?>][features]" rows="5" placeholder="<?php echo $entry_features; ?>" id="input-features<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['features'] : ''; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-yt_video<?php echo $language['language_id']; ?>"><?php echo $entry_yt_video; ?></label>
                <div class="col-sm-10">
                  <textarea name="product_description[<?php echo $language['language_id']; ?>][yt_video]" rows="5" placeholder="<?php echo $entry_yt_video; ?>" id="input-yt_video<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['yt_video'] : ''; ?></textarea>
                </div>
              </div>
            </div>
...
ckeditorInit('input-description<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
        ckeditorInit('input-features1', '<?php echo $token; ?>');
        ckeditorInit('input-yt_video1', '<?php echo $token; ?>');
<?php } else { ?>
