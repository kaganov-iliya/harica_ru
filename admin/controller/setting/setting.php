...
class ControllerSettingSetting extends Controller {
	...
	public function index()
	{
		...
		$data['entry_second_logo'] = $this->language->get('entry_second_logo');
		...
		if (isset($this->request->post['config_second_logo'])) {
			$data['config_second_logo'] = $this->request->post['config_second_logo'];
		} else {
			$data['config_second_logo'] = $this->config->get('config_second_logo');
		}

		if (isset($this->request->post['config_second_logo']) && is_file(DIR_IMAGE . $this->request->post['config_second_logo'])) {
			$data['second_logo'] = $this->model_tool_image->resize($this->request->post['config_second_logo'], 100, 100);
		} elseif ($this->config->get('config_second_logo') && is_file(DIR_IMAGE . $this->config->get('config_second_logo'))) {
			$data['second_logo'] = $this->model_tool_image->resize($this->config->get('config_second_logo'), 100, 100);
		} else {
			$data['second_logo'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_main_seo_text'])) {
			$data['config_main_seo_text'] = $this->request->post['config_main_seo_text'];
		} else {
			$data['config_main_seo_text'] = $this->config->get('config_main_seo_text');
		}
